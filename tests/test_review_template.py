...
class ReviewTemplateTests(unittest.TestCase):
    ...
    def test_checkpoint_first_skips_overview_and_supports_prompt_only(self):
        self.assertIn("跳过总览图", self.default_content)
        self.assertIn("没有生图模型", self.default_content)
